...
users:list = [{"name": "Kaja", "surname": "Wawrzusiszyn", "location": "Tomaszów Lubelski", "posts": 69}]
...
def add_user():
    ...
    users.append(
        {
            "name": imie, "surname": nazwisko, "location": miejscowosc, "posts": posty
        })
    print(users)
...
label_posts_szczegoly_obiektow=Label(ramka_szczegoly_obiektow, text="Liczba postów: ")
label_posts_szczegoly_obiektow.grid(row=1, column=4)
...
label_location_szczegoly_obiektow=Label(ramka_szczegoly_obiektow, text="Miejscowośc: ")
label_location_szczegoly_obiektow.grid(row=1, column=6)
label_location_szczegoly_obiektow_wartosc=Label(ramka_szczegoly_obiektow, text="....")
label_location_szczegoly_obiektow_wartosc.grid(row=1, column=7)
